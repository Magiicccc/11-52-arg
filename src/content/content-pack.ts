...
import rawLongFormItems from "../../content/case-001/apps/long-form-content-items.json";
import rawLongFormToutiaoItems from "../../content/case-001/apps/long-form-toutiao-content-items.json";
...
export const contentItems = [...rawItems, ...rawA3Items, ...rawUiPass2Items, ...rawLongFormItems, ...rawLongFormToutiaoItems].map((value) => contentItemSchema.parse(value)) as unknown as ContentItem[];
